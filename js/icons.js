...
const PATHS = {
  ...
  leaf:      '<path d="M5 19c-1-7 3.5-13.5 14-13.5C19 16 12.5 20 5 19z"/><path d="M5 19c2.5-5 5.5-7.5 9.5-9.5"/>',
  fuel:      '<path d="M5 20.5V6a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v14.5"/><path d="M4 20.5h10"/><path d="M5.5 11.5H13"/><path d="M13 8l3 3v6a1.6 1.6 0 0 0 3 0V9.5L16 6.5"/>',
  wrench:    '<path d="M14.5 6.3a3.8 3.8 0 0 0 5 5l-2.4-.8-1.8-1.8z"/><path d="M14.3 10.7 5.7 19.3a1.7 1.7 0 0 0 2.4 2.4l8.6-8.6"/>',
  phone:     '<rect x="7" y="3" width="10" height="18" rx="2.4"/><path d="M10.5 18h3"/>',
  laptop:    '<rect x="5" y="5.5" width="14" height="9" rx="1.6"/><path d="M3 18h18"/><path d="M9.5 18l.4-3.5h4.2l.4 3.5"/>',
  building:  '<rect x="5.5" y="3.8" width="13" height="16.4" rx="1.4"/><path d="M9 8h2M13 8h2M9 11.5h2M13 11.5h2M9 15h2M13 15h2"/><path d="M9.5 20.2v-2.2h5v2.2"/>',
  briefcase: '<rect x="3.6" y="7.5" width="16.8" height="11" rx="2"/><path d="M8.6 7.5V6a1.6 1.6 0 0 1 1.6-1.6h3.6A1.6 1.6 0 0 1 15.4 6v1.5"/><path d="M3.6 12.5h16.8"/>',
  paperclip: '<path d="M19 11.5l-7.6 7.6a4 4 0 0 1-5.7-5.7l8-8a2.6 2.6 0 0 1 3.7 3.7l-7.9 7.9a1.2 1.2 0 0 1-1.7-1.7l7.2-7.2"/>',
