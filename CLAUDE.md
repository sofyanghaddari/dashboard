...
+35. **🫒 AJAR v29 — scrollspy-dossiernavigatie (17 juli 2026):** slanke rail rechts op Product & Zakelijk (desktop ≥1200px): dot per genummerde sectie, actieve dot wordt gouden pill + label (labels = sectie-kickers, automatisch vertaald), klik scrolt via bestaande ankernavigatie. Nieuwe ui-sleutel `onThisPage` in alle drie de content-bestanden. `initSectionSpy()` in main.js.
