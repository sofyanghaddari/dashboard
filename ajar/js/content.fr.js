...
window.AJAR_CONTENT_FR = {
  ...
  ui: {
    ...
    errSample: "Veuillez renseigner le nom de l’entreprise, le contact, l’e-mail, un numéro KvK valide (8 chiffres) et l’adresse de livraison.",
  ...
  sample: {
    ...
    form: {
      ...
      kvkPlaceholder: "8 chiffres — obligatoire pour les clients professionnels",
