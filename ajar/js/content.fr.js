...
window.AJAR_CONTENT_FR = {
  ...
  ui: {
    ...
    contactHeading2: "Demande et coordonnées",
    sampleStepsHeading: "Comment ça marche",
    ...
    errSample: "Veuillez renseigner le nom de l’entreprise, le contact, l’e-mail, un numéro de TVA valide et l’adresse de livraison.",
    verifyingBtw: "Vérification de l’entreprise…",
    errInvalidBtw: "Nous ne reconnaissons pas ce numéro de TVA dans le contrôle de l’UE (VIES). Veuillez le vérifier — par exemple NL123456789B01.",
    errDuplicateSample: "Cette entreprise a déjà reçu un échantillon gratuit. Des questions ? Envoyez-nous un message WhatsApp.",
  ...
  home: {
    hero: {
      ...
      sub: "Pressée à froid par une seule famille au Maroc, importée directement pour la restauration et les épiceries fines néerlandaises. Un bon choix si vous placez la qualité avant le prix au litre le plus bas et cherchez un fournisseur durable, pas une affaire ponctuelle."
    },
    kernpunten: {
  ...
  about: {
    ...
    timeline: {
      ...
      items: [
        ...
        { year: "Octobre 2024", title: "AJAR au SIAL Paris", text: "AJAR présente l’huile au SIAL Paris à Paris Nord Villepinte — le plus grand salon international de l’alimentation au monde. Une première rencontre avec le marché européen.", todo: false },
  ...
  b2b: {
    ...
    audiences: {
      ...
      items: [
        ...
        { title: "Vous gagnez grâce à l’histoire derrière l’huile", text: "Une huile à la provenance réelle, une seule famille et un savoir-faire se vend mieux qu’une bouteille anonyme — l’histoire est un argument de vente sur lequel vous faites de la marge." },
        { title: "Vous cherchez un fournisseur durable", text: "Vous préférez bâtir une relation avec un interlocuteur unique qui tient ses promesses, plutôt que d’enchaîner les affaires ponctuelles." },
  ...
  sample: {
    ...
    form: {
      ...
      btwPlaceholder: "Ex. NL123456789B01 — obligatoire pour les clients professionnels",
      kvkLabel: "Numéro de registre du commerce (KvK)",
      kvkPlaceholder: "8 chiffres (facultatif)",
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: "Quelles données collectons-nous ?", body: "Trois types. (1) Données de formulaire : lorsque vous demandez un échantillon, un devis ou une présentation, nous recevons les informations que vous saisissez vous-même — nom, nom de l’entreprise, numéro de TVA et (facultatif) numéro de registre du commerce (KvK) pour une demande d’échantillon, adresse e-mail, numéro de téléphone, adresse de livraison et votre message. (2) Newsletter : si vous vous inscrivez, nous conservons uniquement votre adresse e-mail. (3) Statistiques de visite : nous utilisons GoatCounter, un service de statistiques respectueux de la vie privée qui ne place aucun cookie et ne collecte aucune donnée personnelle, pour voir de façon anonyme comment le site est utilisé (pages visitées, provenance de la visite). Rien n’est stocké sur votre appareil, donc aucun consentement n’est requis pour cela." },
      ...
      { title: "Qui traite des données pour nous ?", body: "Les formulaires sont traités techniquement par Formspree ; les statistiques de visite par GoatCounter. Des conditions de sous-traitance s’appliquent avec ces parties. Pour une demande d’échantillon, nous vérifions le numéro de TVA que vous indiquez via VIES, le service de validation officiel de la Commission européenne ; pour éviter qu’une même entreprise demande plusieurs échantillons gratuits, nous ne conservons à cet effet qu’une référence chiffrée (hachée) — pas le numéro de TVA lui-même. Le site est hébergé sur GitHub Pages (GitHub, Inc.) ; comme pour tout serveur web, l’hébergeur peut traiter temporairement des données techniques comme les adresses IP. Les polices de caractères et tous les autres éléments du site sont chargés depuis notre propre hébergement — aucune donnée ne part vers des tiers pour cela. Si vous envoyez un message WhatsApp, les conditions de WhatsApp s’appliquent." },
  ...
  terms: {
    ...
    sections: [
      ...
      { title: "8. Échantillons gratuits", body: "Les échantillons sont gratuits et ne vous engagent à rien. Aucun droit pour des livraisons ultérieures ne peut être tiré d’un échantillon : celui-ci reflète l’huile du moment, et en tant que produit naturel, un lot ultérieur peut légèrement varier dans le cadre de la norme extra vierge. Les échantillons sont disponibles dans la limite des stocks, un échantillon gratuit par entreprise. Pour confirmer que vous êtes un client professionnel, nous demandons votre numéro de TVA lors d’une demande d’échantillon, que nous vérifions via VIES (le service de validation de la Commission européenne)." },
  ...
  newsletter: {
    ...
    text: "Laissez votre adresse e-mail pour les actualités et mises à jour d’AJAR.",
    placeholder: "Votre adresse e-mail",
    button: "S’inscrire",
    success: "Merci — vous aurez de nos nouvelles très prochainement.",
