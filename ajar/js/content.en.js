...
window.AJAR_CONTENT_EN = {
  ...
  ui: {
    ...
    errSample: 'Please fill in your company name, contact person, e-mail address, a valid VAT number and delivery address.',
    verifyingBtw: 'Checking business…',
    errInvalidBtw: 'We don’t recognise this VAT number in the EU check (VIES). Please verify it — for example NL123456789B01.',
    errDuplicateSample: 'This business has already received a free sample. Questions? Feel free to send us a WhatsApp message.',
  ...
  sample: {
    ...
    form: {
      ...
      companyLabel: 'Company name',
      btwLabel: 'VAT number',
      btwPlaceholder: 'E.g. NL123456789B01 — required for business customers',
      kvkLabel: 'Chamber of Commerce (KvK) number',
      kvkPlaceholder: '8 digits (optional)',
  ...
  terms: {
    ...
    sections: [
      ...
      { title: '8. Free samples', body: 'Samples are free of charge and do not obligate you to anything. No rights for future deliveries can be derived from a sample: the sample reflects the oil at that moment, and as a natural product a later batch may differ slightly within the extra virgin standard. Samples are available while stocks last, one free sample per business. To confirm you are a business customer, we ask for your VAT number when you request a sample, which we check via VIES (the European Commission’s validation service).' },
