...
window.AJAR_CONTENT_EN = {
  ...
  ui: {
    ...
    errSample: 'Please fill in your company name, contact person, e-mail address, a valid KvK number (8 digits) and delivery address.',
  ...
  sample: {
    ...
    form: {
      ...
      kvkPlaceholder: '8 digits — required for business customers',
  ...
  terms: {
    ...
    sections: [
      ...
      { title: '8. Free samples', body: 'Samples are free of charge and do not obligate you to anything. No rights for future deliveries can be derived from a sample: the sample reflects the oil at that moment, and as a natural product a later batch may differ slightly within the extra virgin standard. Samples are available while stocks last, one free sample per business. To confirm you are a business customer, we ask for your Chamber of Commerce (KvK) number when you request a sample.' },
